...
export type ConversationPropsFragment = { __typename?: 'Conversation', id: string, note?: string | null, status: ConversationStatus, insertedAt?: any | null, occurredAt: any, deletedAt?: any | null, creator: { __typename?: 'Participant', id: string, name: string }, invitees: Array<{ __typename?: 'Invitee', id: string, name: string }>, signatures: Array<{ __typename?: 'Signature', id: string, signedAt: any, signer: { __typename?: 'Contact', id: string, name: string, org: string, role: string } }> };
