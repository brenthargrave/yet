...
export type ViewConversationQuery = { __typename?: 'RootQueryType', getConversation?: { __typename?: 'ConversationPayload', conversation?: { __typename?: 'Conversation', id: string, invitees: Array<{ __typename?: 'Invitee', name: string }> } | null, userError?: { __typename?: 'UserError', message: string } | null } | null };
